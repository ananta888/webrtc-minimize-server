...
| Publikationsbezogener Peer-DAG | getrennte Membership-/Route-/Topology-Epochen, kurzlebige Leases, Primary/Backup, Ressourcen-Admission, Quorum-Health und Mesh-Fallback; der alte Browser-Relay dekodiert/re-encodiert und ist nur im expliziten Legacy-Modus aktiv | portabler, nicht entschlüsselnder SFrame-/Ciphertext-Medien-DAG zwischen Browsern bleibt offen; ein Edge-TURN-Knoten ist Paketrelay, kein Medien-DAG |
