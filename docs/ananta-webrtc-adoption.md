...
| E2EE und Security-Epochen | nur WebRTC-Transportverschlüsselung, ausdrücklich als aktuelle Systemgrenze dokumentiert | SFrame/Encoded Transform, Geräteschlüssel, Replay-Fenster, Rotation |
...
Der Raumserver übernimmt keine Ananta-Anwendungslogik und keine Python-/Angular-Abhängigkeiten. Das reduziert die Oberfläche auf einen eigenständigen Node-Server und eine Browser-App. Der Server ist keine SFU: Medien und DataChannel-Inhalte passieren ihn nicht.
