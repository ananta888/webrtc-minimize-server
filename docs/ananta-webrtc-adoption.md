...
| Bounded DataChannel | Chat/Control, versionierte lokale Vosk-Untertitel sowie browserseitiger ECDH-/AES-GCM-Overlay; Caption-Text/Rate/Revision und Overlay-Traffic-Class-Queues, Digest, Replay, TTL, Hop-/Path-Cap, Chunk-ACK und Resume sind getrennt begrenzt | verbindlicher Delivery-SLO und große Artefakte außerhalb des Browser-Speichers |
