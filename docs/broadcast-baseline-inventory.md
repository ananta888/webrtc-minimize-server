...
| Infrastruktur-TURN | Coturn auf Oracle | DTLS-SRTP-/SFrame-Inhalt bleibt verschlüsselt; sichtbar sind Netzmetadaten | UDP und TCP 3478 beobachtet; Relay-Portbereich ist Operator-Runtime und wird hier nicht erfunden | zusätzliche Relay-Bandbreite pro PeerConnection | Kurzlebige REST-Credentials und reale All-TURN-Agentmatrix bestanden. Aktuelle kleine Oracle-Quoten sind kein 20er-Kapazitätsnachweis. TURN/TLS 5349 wurde nicht als aktiv beobachtet. |
