...
export interface OwnedNativePackager {
  ...
  readonly capability: Readonly<{ ffmpegVersion: string; health: string; maximumRenditions: number;
    capabilityVersion?: number; sourcePrograms?: boolean; sourceAudioControlVersion?: number; sourceAudioEncodingVersion?: number; sourceSceneControlVersion?: number }> | null;
