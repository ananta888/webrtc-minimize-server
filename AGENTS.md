...
- Room-Membership, Peer-IDs und Medien bleiben flüchtig. Nur ausdrücklich aktivierte Pair-Workspace-Metadaten und Events sowie ausdrücklich konfigurierte Raumverzeichnis-Metadaten (Raum-ID, Titel, Sichtbarkeit, Owner-Principal, Zeitstempel; `ROOM_DIRECTORY_DB`) dürfen im konfigurierten Store persistieren.
